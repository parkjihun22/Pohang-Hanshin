...
const handleInputChange = (e) => {
 ...
 const newsList = [
   {
     id: 1,
     title: "살아나는 부동산 시장...대우건설 시공 ‘포항 펜타시티 한신더휴’ 관심↑",
     excerpt:
   ...
   },
   {
    ...
    excerpt:
      "한신공영이 2021년 리뉴얼 된 새로운 ‘한신더휴’ BI를 적용한 첫 단지인 ‘포항 펜타시티 한신더휴’의 입주예정자들로부터 뜨거운 호응을 얻고 있다고 27일 밝혔다. 세심한 시공과 품격 있는 설계를 통해 입주 전부터 긍정적인 평가를 받았으며, 입주자 협의회와의 활발한 소통이 업계의 모범사례로 주목받고 있다. 또한 올해 하반기 양주와 평택에서 예정된 수도권 신규 분양에 대한 기대도 높아지고 있다.포항 펜타시티 한신더휴는 2021년 리뉴얼된 B.I를 신규 적용한 첫 단지로 올 12월 입주를 앞두고 있다. 포항 펜타시티 한신더휴는 한신공영이 새롭게 정립한 브랜드 가치를 처음으로 적용한 프로젝트다. 한신공영은 2021년 전면적인 브랜드 리뉴얼을 통해 '한신더휴'를 프리미엄 주거 브랜드로 재정립하며, 고급화된 디자인과 혁신적인 주거 솔루션을 통해 한차원 높은 주거 솔루션을 제공하는 데 집중했다.포항 펜타시티 한신더휴는 특히, 공용부문과 조경 설계에 세심한 공을 들였다. 한신공영은 입주민들의 일상적인 동선과 커뮤니티 공간 활용도를 고려한 설계를 바탕으로, 고품격 마감재를 적용하고 디테일한 시공 관리를 실시했다. 특히, 조경 설계에서는 다양한 테마가 적용되어, 단지 내 각 동마다 독특한 분위기를 연출했다.최근 진행된 입주자 사전점검에서는 이러한 노력의 결과가 여실히 드러났다. 일반적으로 입주예정자 협의회에서는 하자나 시공 불량 등 불만족 사항을 지적하는 경우가 많은 데 반해, 포항 펜타시티 한신더휴 입주예정자들은 오히려 긍정적인 평가를 쏟아내고 있다.박희철 입주자 협의회 회장은 “4세대 아파트답게 티하우스, 물놀이터, 조깅트랙 및 농구·축구를 할 수 있는 다목적체육관, 실내 골프장, 키즈클럽, 작은 도서관, 독서실 등 쾌적하고 풍부한 커뮤니티 시설이 갖춰져 있다”라면서 “입주민들에게 수준 높은 생활 인프라를 제공하는 만큼 입주가 기다려진다”고 밝혔으며, 가장 마음에 드는 점으로 ‘조경’을 꼽았다.그는 “조경설명회에서 입주민들과의 협의를 통해 동마다 포인트 될 수 있는 묘목을 하나씩 배치하기로 해 아파트 단지 요소요소 마다 다른 분위기를 조성했다”면서, “미로공원, 팽나무길. 어린이공원 등 다양한 조경시설은 포항 펜타시티 한신더휴의 자랑거리”라고 말했다. 그러면서 “공원을 통해 횡단보도를 건너지 않고 초등학교에 바로 갈 수 있어 교육여건도 좋은 아파트”라고 강조했다.예비 입주자들은 입주자들과 적극적으로 협의하고자 하는 한신공영의 자세에 크게 만족하고 있다. 보통 마감재부터, 공정상의 절차, 조경, 도색 등 주거환경과 직결된 다양한 사안이 산재해 있어 시공사와 입주민의 의견 충돌을 필연적인 부분이다. 그러나 한신공영의 ‘입주민과의 소통’을 중시하며 입주예정자의 권익을 위해 노력하고 소통에 나서면서 입주민들의 만족도를 끌어 낸 것은 물론이고 건설업계의 귀감이 되고 있다.한신공영의 새로운 브랜드가치는 후속 프로젝트를 통해 전국으로 확산되고 있다. 현재 아산권곡 한신더휴와 오산세교 한신더휴가 성공적으로 공사가 진행 중이며, 특히 올해 11월에는 수도권 핵심지역인 양주덕계와 평택브레인시티에서 한신더휴 신규 분양을 앞두고 있다. 앙주 덕계동에는 ‘덕계역 한신더휴 포레스트(724세대)’가, 평택 브레인시티에는 ‘평택 브레인시티 한신더휴(991세대)’가 공급 예정이다. 문화예술을 담은 공간으로 건설업계 및 소비자들에서 주목 받고 있다. 한신더휴는 미래형 스마트시티의 중심 주거단지로 조성된다. 두 단지 모두 한신공영의 혁신적인 설계와 우수한 시공력이 접목되어 지역을 대표하는 랜드마크 단지가 될 것으로 기대를 모으고 있다.한신공영 관계자는 포항 펜타시티 한신더휴의 성공적인 사례를 바탕으로, 앞으로 분양되는 모든 단지에서도 한신더휴만의 차별화된 프리미엄 가치를 선보일 것이라며 특히 하반기 수도권 신규 분양 단지들을 통해 한 차원 높은 주거문화의 새로운 기준을 제시하겠다고 밝혔다.",
    date: "2024. 10. 10.",
  ...
  {
    id: 4,
    title: "한신공영, 포항 펜타시티 한신더휴 성공신화 이어간다",
    excerpt:
      "경북 포항 펜타시티 입주 현장에서 만난 주민 A씨는 새로운 도시와 자신의 새집을 바라보며 감회가 새롭다고 전했다. 그는 “새 도시와 새 집이 함께 생기니 펜타시티 전체가 마치 내 집 같습니다”며 기쁜 마음을 표현했다.최근 방문한 포항 펜타시티 현장은 이미 완연한 도시였다. 공정이 대부분 마무리된 아파트들이 위용을 뽐내는 가운데, 주민들의 포장이사가 곳곳에서 진행되고 있었다.포항 북구 흥해읍에 조성된 복합자족신도시 펜타시티는 바이오·에너지·나노·글로벌 비즈니스와 주거를 아우르는 대규모 신도시이다. 이곳은 5개 단지 4천여 세대의 아파트가 올해 말부터 내년 초까지 일제히 입주를 시작하며 도시로서의 면모를 완성해가고 있다.특히, KTX포항역과 인접해 있으며, 앞으로 추가 개발 예정인 KTX신도시지구, 대련지구, 이인지구와 연결돼 주거와 인프라 라인이 더욱 확장될 것으로 기대를 모으고 있다.현지 공인중개사 B씨는 “초기에는 신도시에 대해 의구심을 가지는 사람들이 많았지만, 직접 현장을 보면 생각이 바뀔 수밖에 없습니다”라고 강조했다. 그는 “한신더휴를 비롯해 우수한 상품성을 가진 아파트들이 들어서면서 펜타시티의 전체적인 지역 가치가 급격히 상승했습니다”라고 설명했다.또 다른 한신더휴 입주 예정자 C씨는 “사전 점검일에 처음 방문했는데, 전혀 새로운 도시가 생긴 것 같아 놀랐습니다. 도시 전체가 깨끗하고 정돈된 느낌이며, 최신 브랜드 아파트의 상품성도 충분히 만족스럽습니다”라고 말하며 입주에 대한 기대감을 드러냈습니다.한신더휴는 입주민들의 생활 동선과 커뮤니티 활용도를 고려한 설계, 고품격 마감재, 디테일한 시공관리로 주거 품질을 한 단계 끌어올렸다.특히, 테마 조경 설계를 통해 각 동마다 고유의 분위기를 연출하고, 티하우스, 물놀이터, 조깅트랙, 다목적 체육관, 실내 골프장 등 다채로운 커뮤니티 시설을 마련해 입주민들에게 큰 호평을 받고 있다.한신공영 관계자는 “조경 설계에 대한 입주민들의 만족도가 매우 높습니다. 포항 펜타시티 한신더휴는 브랜드의 시공력을 보여주는 대표 사례가 될 것입니다”라며, “포항 펜타시티에서 입증된 상품경쟁력을 양주 덕계와 평택 브레인시티에서도 이어갈 것”이라고 강조했다. 특히 “평택 브레인시티의 경우, 우수한 광역교통망과 생활 인프라를 바탕으로 수도권 남부의 새로운 주거벨트로 자리매김할 것”이라고 자신감을 내비쳤다.전문가들은 한신더휴의 브랜드 파워가 평택 브레인시티에서도 통할 것으로 기대하고 있다. 이미 택지개발 초기 단계에서 우수한 입지를 선점했으며, 검증된 상품성과 세련된 설계로 미래 가치 상승이 예상된다는 분석이다.특히, 초등학교와 대학병원 등 핵심 인프라가 단지 인근에 들어설 예정인 만큼, 이를 기반으로 안정적인 생활 환경이 조성될 것이다. 전문가들은 “미래 가치를 보고 투자하는 수요자들의 관심이 꾸준히 이어질 것”이라고 전망했다.",
    date: "2024. 10. 10.",
    link: "/pentacityhansin/press/jHg9NfqvD4iVADTOAXNn",
    image: news4Img
  },
   // ...원하시는 만큼 항목 추가
 ];

        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextBox}>
              ...
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>포항이 기다린</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  ...
                  - 포항 지제역 1호선, STR, KTX, GTX-A · C 확정으로 펜타역세권{" "}
            ...
            <div className={styles.section8}>
              <div className={styles.textBox}>
                <div className={styles.title}>
                  소수만 누릴 수 있는<br />
                  <span>최고의 브랜드 아파트<br /> 포항 펜타시티 한신더휴</span>
                </div>
              ...
              <img src={section8Img3} alt="포항 펜타시티 한신더휴 입지환경소개-image2" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="포항 펜타시티 한신더휴아파트 조감도-image3"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="포항 펜타시티 한신더휴 브랜드소개-image4" />
    ...
    <button type="submit">등록하기</button>
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 포항 펜타시티 한신더휴 중심상업지구 가장인접한 입지
              <br />
              - 첨단 아주대학교 AI종합병원, 의료R＆D센터 도보 5분
              <br />
              - 포항 반도체클러스터 삼성전자 포항캠퍼스, SK하이닉스 
          ...
          <DarkComplexSection />
           ...
           <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="펜타시티 한신더휴 mobile입지안내-image1"
            />
          </div> 
           ...
           <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 펜타시티 한신더휴 <br />
                모델하우스에서 확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="펜타시티 한신더휴 mobile조감도-image1"
            />
          </div> 
          <UnitInfoSection />
          ...
          <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="펜타시티 한신더휴 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="포항 펜타시티 한신더휴 오시는길안내-mobileimage2" />
            </div>
          </div> */}

...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>포항 펜타시티 한신더휴 - 당첨자 서류안내</title>
		<meta
		  name="description"
		  content="포항 펜타시티 한신더휴 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
"
		/>
  		<meta name="keywords"
		...
		<link
		  rel="canonical"
		  href="https://www.theporest.co.kr/BusinessGuide/documents"
		/>

		{/* Open Graph - 소셜 미디어 공유 최적화 */}
		<meta
		  property="og:title"
		  content="포항 펜타시티 한신더휴 - 당첨자 서류안내"
		/>
		<meta
...
"
		...
		<meta
		  property="og:url"
		  content="https://www.theporest.co.kr/BusinessGuide/documents"
		/>
		  ...
		  {`
										{
											...
											"@type": "WebPage",
											"name": "포항 펜타시티 한신더휴 - 당첨자 서류안내",
											"description": "포항 펜타시티 한신더휴 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
",
											"url": "https://www.theporest.co.kr/BusinessGuide/documents"
										}
										`}
		</script>
	  </Helmet>  
            ...
            <h1 className={styles.screenReaderOnly}>포항 펜타시티 한신더휴  - 계약서류안내</h1>
			...
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="포항 펜타시티 한신더휴 계약서류안내-image1" />
